class Address < ApplicationRecord
  ...
  def street_must_be_string
    ...
    return unless street_before.size <= 2
  ...
  def city_must_be_string
    ...
    return unless city_before.size <= 2
  ...
  def postal_code_must_be_string
    ...
    return unless postal_code_before.size <= 4
  ...
  def country_must_be_string
    ...
    return unless country_before.size <= 2
